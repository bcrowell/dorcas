# https://github.com/dryruby/json-canonicalization
# Gregg Kellogg and Xavier Delamotte 
# unlicense license: json-canonicalization/LICENSE
# I cut and pasted this into my project so that users wouldn't have to install a separate ruby gem.
