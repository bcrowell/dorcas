...
def find_submedian(x,median)
  # This is just my made-up term for the median of all data that lie below the median.
  # The median is an input for reasons of efficiency -- we've probably already needed to calculate it anyway.
  return find_median(x.select{ |a| a<median})
end
